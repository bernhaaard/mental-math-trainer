...
/**
 * Learning path component showing the recommended progression.
 */
  ...
  return (
    <div className="mb-10 rounded-lg border border-border bg-card p-6">
      ...
      <div className="flex flex-wrap items-center gap-2 text-sm">
        ...
        {METHODS.sort((a, b) => a.order - b.order).map((method, index) => (
          <span key={method.name} className="flex items-center">
            <Link
              href={`/study/${method.name}`}
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-foreground mb-2">
          Study Calculation Methods
        </h1>
        <p className="text-lg text-muted-foreground">
          Master six powerful mental math techniques. Each method includes
          mathematical foundations, worked examples, and interactive exercises.
        </p>
      </header>
